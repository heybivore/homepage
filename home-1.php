...
<body class="bg-light">
    <header>
        <nav class="bg-white container-fluid py-1 border-bottom shadow">
            <img class="me-1 d-inline" src="img/city-gov-davao-logo-2.jpg" alt="City Government of Davao Logo"  width="24px">
            <a href="home.php" class="align-middle d-inline-block h-name">CGDeS Portal</a>
            <ul class="align-middle m-0 d-inline">
                <li class="d-inline align-middle px-2 border-end border-3"><a href="#">optional</a></li>
